...
-- Dumping data for table rms.issued_details: ~10 rows (approximately)
...
INSERT INTO `issued_details` (`issued_to`, `issued_date`, `marked_no`, `remark`, `stock_id`, `status_id`, `ilocation`, `i_form_no`, `g_form_no`) VALUES
	(37, '2022-04-14', 'm101', 'r101', 29, 2, NULL, NULL, NULL),
	(37, '2022-04-14', 'm101', 'r101', 29, 2, NULL, NULL, NULL),
	(41, '2022-04-14', 'dfdf', 'fewfw', 4, NULL, NULL, NULL, NULL),
	(30, '2022-04-22', 'dbfdnb', 'gfmnghmng', 30, 2, NULL, NULL, NULL),
	(31, '2022-04-21', 'gfnhfn', 'ngmnygtmnyt', 31, NULL, NULL, NULL, NULL),
	(41, NULL, 'rhbrehb', 'gerg', 37, 2, NULL, NULL, NULL),
	(29, '2022-04-15', 'rgerg', 'errhb', 39, NULL, NULL, NULL, NULL),
	(29, '2022-04-15', 'm1113', 'bgterjhtryj', 30, NULL, NULL, NULL, NULL),
	(30, NULL, 'trnbrnr', 'nnhytmm', 6, NULL, NULL, NULL, NULL),
	(30, '2022-04-09', 'dbn', 'nnn', 6, NULL, NULL, NULL, NULL);
...
INSERT INTO `mas_user` (`user_id`, `name`, `dept_code`, `mobile_no`, `email_id`, `emp_type_id`, `joining_date`, `resigning_date`, `address`, `machine_ip`, `password`, `role`) VALUES
	(27, 'DEVENDRA CHANDRAKAR ', 4, 9098542380, 'chandrakardr@gmail.com ', 1, '2018-01-11', NULL, 'vill- Farhada,kosrangi kharoara Raipur 493225', NULL, '$2a$10$urWXuPXf8pqZIrEPDkXxHuKvrwXd49Co85TMELwbmMlNgWRFWXyJW', 1),
	(28, 'KAMAL KISHORE ', 4, 8871952002, 'kamalKishore518@gmail.com ', 1, '2018-12-05', NULL, 'Mahadev ghat, Raipur 492013', NULL, '$2a$10$urWXuPXf8pqZIrEPDkXxHuKvrwXd49Co85TMELwbmMlNgWRFWXyJW', 2),
	(29, 'SHIVA MANHAR ', 3, 9098704107, 'shivamanhar@gmail.com', 1, '2018-11-27', NULL, 'Garm jarveJaijaipur, Chattisghar,495690', NULL, NULL, NULL),
	(30, 'SHUBHAM ROY ', 21, 9630744005, 'shubh.0609sep@gmail.com ', 1, '2021-10-01', NULL, 'FALT NO.804 BLOCK.A  VIP HEIGHTS SADDU Raipur ', NULL, NULL, NULL),
	(31, 'LOKESH KUMAR CHAWADA ', 4, 8120061699, 'lokeshchawada@gmail.com ', 1, '2013-11-01', NULL, NULL, '10.132.36.114', NULL, NULL),
	(32, 'ABHISHEK KUMAR ', 4, 7587762255, 'abhisheksr72@gmail.com', 3, '2013-04-16', NULL, 'WOLFFOT.WATIKA KATHADHI POLT Na.99 KATHADHI ', NULL, NULL, NULL),
	(33, 'ANURANG KUMAR ', 1, 8965820968, 'anuragdhiwar928@gmail.com', NULL, '2021-10-20', NULL, 'NEAR,DURGA TEMPLE.KOSA,JAJGIR-CHAPA (C.G).495663', NULL, NULL, NULL),
	(34, 'AJAY KUMAR ', 19, 9755653738, 'ajaykumar974@gmail.com', 1, '2021-06-01', NULL, 'H.NO-346,WARD-17,.PATHARRIPARA  C.S.E.B KORBA (EAST)(C.G) 494334', NULL, NULL, NULL),
	(35, 'RUKHSAR MIRJA ', 4, 7000644061, 'rukhsarmirja757@gmail.com', 3, '2021-10-11', NULL, 'H.NO-19/4.JAIL COLONY,MG WORD DIST JAIL KANKER (C.G)494334', NULL, NULL, NULL),
	(36, 'SANDEEP TIWARI ', 4, 7415313383, 'sandeep706@gmail.com', 3, '2021-10-08', NULL, 'SECTOR-3 STREET NO-15 PROFERSSER COLONY SUMERU MATH RAIPUR (.C.G)', NULL, NULL, NULL),
	(37, 'GESHWAR KUMAR DHANKAR ', 4, 7566427457, 'geshwardhankar@gmail.com', 3, '2021-12-09', NULL, '92/KM.AWASPARA ,PURI TEH-CHARAMA,DIST-KANKER 494337', NULL, NULL, NULL),
	(38, 'ABHIJEET MUKHERJEE', 1, 9827884606, 'abhijeet.2301@gmail.com', 3, '2021-12-02', NULL, 'H,NO 4309,WORD 60,RAVATPURA PHASE-2,RAIPUR (C.G)', NULL, NULL, NULL),
	(39, 'PRITAM KUMAR TANDAN ', 4, 9926130834, 'pritamtandan@gmail.com', 3, '2021-10-12', NULL, 'C/O PANNNALA, NERRIDIH,BARBANDA MANDHAR, RAIPUR.MANDHAR,CHHRHJH .493111', NULL, NULL, NULL),
	(40, 'DEEPAK DHEEWAR ', 4, 9993039522, 'deewar.deepak82@gmail.com', 3, '2021-07-31', NULL, 'VIP,CITY SHDDU,RAIPUR 492001', NULL, NULL, NULL),
	(41, 'ANURAG KUMAR ', 1, 8965820968, 'anuragdhiwar928@gmail.com ', 3, '2021-10-20', NULL, 'NEAR,DURA TEMPLE KOSA JANJGIR CHAMPA (C.G) 495663', NULL, NULL, NULL),
	(42, 'VIJAY KUMAR VSTRAKAR ', 1, 9752680725, 'vijaykumarvastrakar@gmail.com', 3, '2021-09-04', NULL, 'VILL& P.O-GOTORA DIST-BILASPUR ', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `returned_stock_details` (
  ...
  `g_form_no` varchar(50) DEFAULT NULL,
  `glocation` varchar(50) DEFAULT NULL,
...
-- Dumping data for table rms.returned_stock_details: ~27 rows (approximately)
/*!40000 ALTER TABLE `returned_stock_details` DISABLE KEYS */;
INSERT INTO `returned_stock_details` (`stock_id`, `serial_no`, `dept_id`, `was_issued_to`, `returned_date`, `status_id`, `g_form_no`, `glocation`, `remarks`) VALUES
	(29, 'ss33', 'NHM', 'GESHWAR KUMAR DHANKAR ', '2022-04-13', '5', 'g1011', 'gform/file-1649658830241.pdf', 'r1001'),
	(4, 'mm', 'Directorate of Agriculture', NULL, '2022-04-12', '5', 'G1110001', 'gform/file-1649675551049.txt', 'Returned to Agriculture'),
	(6, 'sn001', 'Directorate of Agriculture', NULL, '2022-04-08', NULL, 'Uploaded', 'gform/file-1649741330511.pdf', '8 GB RAM'),
	(32, 's101', 'NHM', NULL, NULL, NULL, '32 gform uploaded', NULL, 'has been ,marked'),
	(34, 'ernjyj', 'NHM', NULL, NULL, '5', 'brfbrbr', NULL, 'vdbrfb'),
	(33, 'dsgergv', 'Health and family welfare', NULL, NULL, NULL, 'hgmhj mjh,kjh,jh', NULL, 'fbfdnghmhgm'),
	(33, 'dsgergv', 'Health and family welfare', NULL, NULL, '5', 'bvfdbfgnb', NULL, 'dvsv'),
	(33, 'dsgergv', 'Health and family welfare', NULL, NULL, '5', 'bvfdbfgnb', NULL, 'dvsv'),
	(30, 'stest', 'Land Records', NULL, NULL, '5', 'ngfgfmnhgmhj', NULL, 'fdbngfn'),
	(30, 'stest', 'Land Records', NULL, NULL, '5', 'ngfgfmnhgmhj', NULL, 'fdbngfn'),
	(30, 'stest', 'Land Records', NULL, NULL, '5', 'ngfgfmnhgmhj', NULL, 'fdbngfn'),
	(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(31, 'sttest2', 'Directorate of Agriculture', NULL, NULL, '5', 'fewgerthrth', NULL, 'nhgmnb'),
	(30, 'stest', 'Land Records', NULL, NULL, NULL, NULL, NULL, 'fdbfrnbtfrn'),
	(32, 's101', 'NHM', NULL, NULL, NULL, NULL, NULL, 'rbgerhbrnbr'),
	(31, 'sttest2', 'Directorate of Agriculture', NULL, NULL, '5', NULL, NULL, 'hgfmnhg,mg'),
	(31, 'sttest2', 'Directorate of Agriculture', NULL, NULL, '5', NULL, NULL, 'hgfmnhg,mg'),
	(31, 'sttest2', 'Directorate of Agriculture', NULL, NULL, '5', NULL, NULL, 'hgfmnhg,mg'),
	(32, 's101', 'NHM', NULL, NULL, NULL, NULL, NULL, 'fdhfdn'),
	(32, 's101', 'NHM', NULL, NULL, NULL, NULL, NULL, 'fdhfdn'),
	(32, 's101', 'NHM', NULL, NULL, NULL, NULL, NULL, 'fdhfdn'),
	(33, 'dsgergv', 'Health and family welfare', NULL, NULL, NULL, 'erhbrtberb', NULL, 'fnytythtrh'),
	(34, 'ernjyj', 'NHM', NULL, NULL, NULL, 'mhgmgh,m', NULL, 'fbgfdgfn'),
	(30, 'stest', 'Land Records', NULL, '2022-04-08', '5', 'g nhg hg ', NULL, 'bffdgbf'),
	(34, 'ernjyj', 'NHM', NULL, NULL, '5', 'gngfjygtmny', NULL, 'fdnbgfngmn'),
	(29, 'ss33', 'NHM', NULL, NULL, '5', 'ngfmngmgm', NULL, 'rhbfdndn');
...
-- Dumping data for table rms.stock_receive_mas: ~16 rows (approximately)
...
INSERT INTO `stock_receive_mas` (`stock_id`, `dept_id`, `hardware_id`, `received_date`, `cpu_sno`, `monitor_sno`, `keyboard_sno`, `mouse_sno`, `make_model_id`, `status_id`, `i_form_no`, `ilocation`, `remarks`) VALUES
	...
	(29, 4, 4, '2022-04-13', NULL, 'ss33', NULL, NULL, 2, '5', 'ii88', NULL, 'rr66'),
	(30, 2, 3, '2022-04-13', NULL, 'stest', NULL, NULL, 2, '2', 'i gtest', NULL, 'test'),
	(31, 3, 3, '2022-04-09', NULL, 'sttest2', NULL, NULL, 3, '2', 'i test 2', NULL, 'remak teste'),
	(32, 4, 4, '2022-04-08', NULL, 's101', NULL, NULL, 2, '1', 'i11010', NULL, 'remarked'),
	(33, 1, 2, '2022-04-15', NULL, 'dsgergv', NULL, NULL, 3, '1', 'gergerg', NULL, 'ergerg'),
	(34, 4, 4, '2022-04-30', NULL, 'ernjyj', NULL, NULL, 3, '5', 'mhhgmhmhm', NULL, 'ytjytjytjymm'),
	(35, 3, 3, '2022-04-15', NULL, 'dsgsgdfhfdh', NULL, NULL, 3, '1', 'ngfnnntn', NULL, 'hfrnbn'),
	(36, 4, 4, '2022-04-07', NULL, 's9393', NULL, NULL, 2, '1', 'ij94954', NULL, 'reksakkf'),
	(37, 3, 3, '2022-04-07', NULL, 'erbgdb', NULL, NULL, 3, '2', 'nhgnhgnhgng', NULL, 'fbfdbgfn'),
	(38, 3, 3, '2022-04-06', NULL, 'ss92993', NULL, NULL, 2, NULL, 'i9839843', NULL, 'rmarksdfd3r32'),
	(39, 1, 3, '2022-04-08', NULL, 's43544', NULL, NULL, 3, '2', 'nhgngn', NULL, 'fbgfb'),
	(40, 4, 3, '2022-04-14', NULL, 's222', NULL, NULL, 3, '1', 'uploaded', 'iform/file-1649758007263.pdf', 'm23324'),
	(41, 4, 4, '2022-04-16', NULL, 'fd65657', NULL, NULL, 2, '1', 'i7678876', 'iform/file-1649758126978.pdf', 'gfn656556'),
	(42, 3, 4, '2022-04-15', NULL, 'mnhbhjh', NULL, NULL, 3, '1', 'jh,jh,jh,', 'iform/file-1649758875896.pdf', 'hmjh,jh,h');
...
-- Dumping data for table rms.stock_transaction_details: ~14 rows (approximately)
/*!40000 ALTER TABLE `stock_transaction_details` DISABLE KEYS */;
INSERT INTO `stock_transaction_details` (`transaction_id`, `stock_id`, `status`, `transaction_date`) VALUES
	(11, 31, NULL, NULL),
	(12, 32, NULL, NULL),
	(13, 33, NULL, '2022-04-12 12:56:20'),
	(14, 34, NULL, '2022-04-12 12:57:31'),
	(15, 30, NULL, '2022-04-12 13:02:19'),
	(16, 34, NULL, '2022-04-12 13:02:59'),
	(17, 29, '5', '2022-04-12 13:12:31'),
	(18, 30, NULL, NULL),
	(19, 31, '2', '2022-04-12 13:25:19'),
	(20, 37, '2', '2022-04-12 13:26:58'),
	(21, 39, '2', '2022-04-12 13:28:28'),
	(22, 30, '2', '2022-04-12 13:29:19'),
	(23, 6, '2', '2022-04-12 13:37:00'),
	(24, 6, '2', '2022-04-12 13:37:27');
